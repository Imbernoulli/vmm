...
| `qwen3_moe_subspace_scaled_candidate` | `materialization_command_ready` | `checkpoint_missing_until_materialized` | `not_run` |  |  | `needs_checkpoint_materialization` | run writer command and verify safetensors output |
