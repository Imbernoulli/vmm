...
| `qwen3_moe_searched_no_gt065_max_retention_candidate` | `materialized_checkpoint_exists` | `ready_to_host` | `not_run` |  |  | `ready_for_vllm_eval` | host_with_vllm_and_run_downstream_eval |
