...
| `final_bound_status_matches_final_selector` | `awaiting_source_eval` | `final selector status = awaiting_source_eval; eligible candidates = 0/10; reason = Both Qwen3 source endpoints must complete audited vLLM eval before final candidate selection..` | `True` |
