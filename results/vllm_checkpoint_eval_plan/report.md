...
| 8 | `qwen_0_5b_instruct_coder_uniform_average` | `ready_to_host` | `complete` | 0.180 | 0.000 | `results/checkpoints/qwen_0_5b_instruct_coder_uniform_average` | 8108 | `results/vllm_checkpoint_eval/qwen_0_5b_instruct_coder_uniform_average` |
| 9 | `moe_route_aware_candidate` | `checkpoint_missing_until_materialized` | `not_run` |  |  | `results/checkpoints/moe_route_aware_candidate` | 8109 | `results/vllm_checkpoint_eval/moe_route_aware_candidate` |
| 10 | `moe_bias_calibrated_candidate` | `checkpoint_missing_until_materialized` | `not_run` |  |  | `results/checkpoints/moe_bias_calibrated_candidate` | 8110 | `results/vllm_checkpoint_eval/moe_bias_calibrated_candidate` |
| 11 | `toy_moe_expert_weight_candidate` | `not_vllm_loadable_toy_candidate` | `not_run` |  |  | `results/checkpoints/toy_moe_expert_weight_candidate` | 8111 | `results/vllm_checkpoint_eval/toy_moe_expert_weight_candidate` |
