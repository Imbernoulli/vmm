...
- Router rows: `42`；expert rows: `168`；specialization rows: `84`

## Router Readiness

Router action counts: `{"freeze_router_and_check_load_balance": 23, "router_probe_passed_for_small_lambda": 16, "calibrate_router_before_average": 3}`
...
| matched_router_hessian_average | toy_router | code | 0.5225 | 0.6234 | 0.9683 | top1_load_concentration | `freeze_router_and_check_load_balance` |

## Expert Load Risks

Expert action counts: `{"low_lambda_or_route_frequency_average": 168}`
...
Specialization action counts: `{"shared_or_mixed_expert": 61, "category_specialized_route_weight": 23}`
