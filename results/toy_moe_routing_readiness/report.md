...
- Router rows: `40`；expert rows: `160`；specialization rows: `80`

## Router Readiness

Router action counts: `{"freeze_router_and_check_load_balance": 21, "router_probe_passed_for_small_lambda": 16, "calibrate_router_before_average": 3}`
...
Expert action counts: `{"low_lambda_or_route_frequency_average": 160}`
...
| matched_router_kd_average | toy_router | code | 3 | 1.38 | none | `low_lambda_or_route_frequency_average` |

## Category Specialization

Specialization action counts: `{"shared_or_mixed_expert": 59, "category_specialized_route_weight": 21}`
