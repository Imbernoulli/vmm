...
- Router rows: `26`；expert rows: `104`；specialization rows: `52`

## Router Readiness

Router action counts: `{"freeze_router_and_check_load_balance": 13, "router_probe_passed_for_small_lambda": 10, "calibrate_router_before_average": 3}`
...
Expert action counts: `{"low_lambda_or_route_frequency_average": 104}`
...
| expert_weight_search_average | toy_router | code | 3 | 1.35 | none | `low_lambda_or_route_frequency_average` |

## Category Specialization

Specialization action counts: `{"shared_or_mixed_expert": 38, "category_specialized_route_weight": 14}`
