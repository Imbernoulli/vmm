...
- Router rows: `18`；expert rows: `72`；specialization rows: `36`

## Router Readiness

Router action counts: `{"freeze_router_and_check_load_balance": 8, "router_probe_passed_for_small_lambda": 7, "calibrate_router_before_average": 3}`
...
| matched_router_calibrated_average | toy_router | general | 0.665 | 0.5814 | 0.8817 | top1_load_concentration | `freeze_router_and_check_load_balance` |
...
| matched_router_calibrated_average | toy_router | code | 0.485 | 0.723 | 0.8375 | none | `router_probe_passed_for_small_lambda` |
| route_aware_expert_average | toy_router | code | 0.4925 | 0.5911 | 1 | none | `router_probe_passed_for_small_lambda` |

## Expert Load Risks

Expert action counts: `{"low_lambda_or_route_frequency_average": 72}`
...
| matched_router_calibrated_average | toy_router | general | 0 | 1.495 | none | `low_lambda_or_route_frequency_average` |
...
Specialization action counts: `{"shared_or_mixed_expert": 26, "category_specialized_route_weight": 10}`
...
| matched_router_calibrated_average | toy_router | 0 | general | 0.7085 | `category_specialized_route_weight` |
