...
- Router rows: `38`；expert rows: `152`；specialization rows: `76`

## Router Readiness

Router action counts: `{"freeze_router_and_check_load_balance": 20, "router_probe_passed_for_small_lambda": 15, "calibrate_router_before_average": 3}`
...
| matched_router_topk_calibrated_average | toy_router | general | 0.7225 | 0.541 | 0.8633 | top1_load_concentration | `freeze_router_and_check_load_balance` |
...
Expert action counts: `{"low_lambda_or_route_frequency_average": 152}`
...
| matched_router_hessian_average | toy_router | code | 3 | 1.37 | none | `low_lambda_or_route_frequency_average` |

## Category Specialization

Specialization action counts: `{"shared_or_mixed_expert": 56, "category_specialized_route_weight": 20}`
