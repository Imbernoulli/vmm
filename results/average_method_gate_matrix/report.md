...
| `final_downstream_acceptance` | `qwen3_final_candidate_selection` | 0.0000 | 8.0000 | `awaiting_source_eval` | status = awaiting_source_eval; eligible candidates = 0/8; reason = Both Qwen3 source endpoints must complete audited vLLM eval before final candidate selection. |
