...
def writer_command_candidates() -> list[dict[str, Any]]:
    specs = [
        ...
        {
            "candidate": "qwen3_moe_audit_gated_candidate",
            "source": "results/qwen3_moe_audit_gated_candidate/writer_command.txt",
            "loadability": "qwen_moe_if_materialized",
        },
        {
            "candidate": "qwen3_moe_trust_region_candidate",
            "source": "results/qwen3_moe_trust_region_candidate/writer_command.txt",
            "loadability": "qwen_moe_if_materialized",
        },
        {
            "candidate": "qwen3_moe_expert_only_trust_region_candidate",
            "source": "results/qwen3_moe_expert_only_trust_region_candidate/writer_command.txt",
            "loadability": "qwen_moe_if_materialized",
        },
        {
        ...
        {
            "candidate": "qwen3_moe_searched_no_gt065_max_retention_candidate",
            "source": "results/qwen3_moe_trust_region_cap_search/searched_no_gt065_max_retention_writer_command.txt",
            "loadability": "qwen_moe_if_materialized",
        },
        {
        ...
        {
            "candidate": "qwen3_moe_mechanistic_unified_candidate",
            "source": "results/qwen3_moe_mechanistic_unified_candidate/writer_command.txt",
            "loadability": "qwen_moe_if_materialized",
        },
        {
            "candidate": "qwen3_moe_subspace_scaled_candidate",
            "source": "results/qwen3_moe_expert_subspace_conflict_probe/writer_command.txt",
            "loadability": "qwen_moe_if_materialized",
        },
        {
